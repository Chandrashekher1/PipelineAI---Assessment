...
export default function Explore() {
    const { pokemon, loading, error, searchPokemonByName, loadMorePokemon } = usePokemon()
        ...
        <div>
            <div className="p-4">
                ...
                <div>
                    ...
                    <PokemonGrid pokemon={pokemon} onSelectPokemon={setSelectedPokemon} loading={loading} error={error} />
                </div>
            </div>
